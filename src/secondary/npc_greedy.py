...
class Greedy_Search:
    ...
    def think(self, action_key_map, character_affecter, current_emotional_state, goal_emotion, step_value = 1):
        ...
        for action_modifier_pair in action_key_map.moves:
            ...
            self.future_states_for_evaluation[self.simulation_index] = (affecter.evaluate_affect_vector(character_affecter.current_affect, self.copied_states[self.simulation_index], goal_emotion), action, modifier)
